...
using System.Linq;
using MvvmCross.Android.Controls.Sample.Core.Helpers;
using MvvmCross.Android.Controls.Sample.Core.Model;
using MvvmCross.Core.ViewModels;

namespace MvvmCross.Android.Controls.Sample.Core.ViewModels
{
